...
public class MessageFormatSupportingAnyTemporalAccessorUnitTests {
    private static String getTimezoneOffset(TimeZone tz) {
        ...
        String offset = String
                .format("%02d%02d", Math.abs(offsetInMillis / 3600000), Math.abs((offsetInMillis / 60000) % 60));
    ...
    public void format_WhenUsingDate_ShouldFormatCorrectly() {
        ...
        GregorianCalendar calendar = new GregorianCalendar(2024, Calendar.MAY, 01, 1, 0);
        ...
        ((SimpleDateFormat) messageFormatToTest.getFormats()[0])
                .setTimeZone(TimeZone.getTimeZone(ZoneId.of("America/New_York")));
    ...
    public void format_WhenUsingLocalDateTime_ShouldFormatCorrectly() {
        ...
        Object[] arguments = new Object[] { date };
        String expected = "2024-05-01 01:00:00" + getTimezoneOffset(TimeZone.getDefault());
        Locale locale = Locale.getDefault();
        MessageFormatSupportingTimePackage messageFormatToTest = MessageFormatSupportingTimePackage.of(pattern, locale);
    ...
    public void format_WhenUsingOffsetDateTime_ShouldFormatCorrectly() {
        String pattern = "{0,date,yyyy-MM-dd HH:mm:ssZ}";
        OffsetDateTime date = OffsetDateTime.of(2024, 5, 1, 1, 0, 0, 0, ZoneOffset.ofHours(5));
        Object[] arguments = new Object[] { date };
        String expected = "2024-05-01 01:00:00+0500";
        Locale locale = Locale.getDefault();
        MessageFormatSupportingTimePackage messageFormatToTest = MessageFormatSupportingTimePackage.of(pattern, locale);
        ((SimpleDateFormat) messageFormatToTest.getFormats()[0])
                .setTimeZone(TimeZone.getTimeZone(ZoneId.of(ZoneOffset.ofHours(5).getId())));
    ...
    public void format_WhenUsingZonedDateTime_ShouldFormatCorrectly() {
        String pattern = "{0,date,yyyy-MM-dd HH:mm:ssZ}";
        ZonedDateTime date = ZonedDateTime.of(2024, 5, 1, 1, 0, 0, 0, ZoneId.of("America/New_York"));
        Object[] arguments = new Object[] { date };
        String expected = "2024-05-01 01:00:00-0400";
        Locale locale = Locale.getDefault();
        MessageFormatSupportingTimePackage messageFormatToTest = MessageFormatSupportingTimePackage.of(pattern, locale);
