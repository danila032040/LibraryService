...
import tests.base.specification.composable.mocks.CompositeSpecificationMock;

public class CompositeSpecificationUnitTests {
    
    @Test
    public void and_ShouldReturnAndSpecificationInstance() {
        CompositeSpecificationMock specification1 = new CompositeSpecificationMock(true);
        CompositeSpecificationMock specification2 = new CompositeSpecificationMock(true);
        
        CompositeSpecification<Integer> actual = specification1.and(specification2);
    ...
    public void and_WhenNullSpecificationIsPassed_ShouldThrowNullPointerException() {
        CompositeSpecificationMock specification = new CompositeSpecificationMock(true);
    ...
    public void or_ShouldReturnOrSpecificationInstance() {
        ...
        CompositeSpecification<Integer> actual = specification1.or(specification2);
