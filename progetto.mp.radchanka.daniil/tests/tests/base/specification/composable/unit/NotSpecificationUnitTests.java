...
public class NotSpecificationUnitTests {
    ...
    public NotSpecificationUnitTests(boolean isBaseSpecificationSatisfied, boolean expectedResult) {
        this.expectedResult = expectedResult;
        
        this.specification = new NotSpecification<>(x1 -> isBaseSpecificationSatisfied);
    }
