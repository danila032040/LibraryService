...
public class DomainEventNotificationPublisherUnitTests {
    ...
    public void publishDomainEvents_ShouldSendNotificationOfTheNotificationDispatcherExactlyOnce() {
        ...
        domainEventPublisher.publishDomainEvents(Lists.newArrayList(domainEvent));
        
        int actualSendNotificationExecutionsCount = notificationDispatcher.getSendNotificationExecutionsCount();
    ...
    public void publishDomainEvents_ShouldWrapDomainEventsToGenericDomainEventNotificationAndSendThemByNotificationDispatcher() {
        ...
        Notification actualNotification = notificationDispatcher.getSubmitedNotifications().get(0);
        
        assertThat(actualNotification)
                .isInstanceOfSatisfying(DomainEventNotification.class, (domainEventNotification) -> {
