...
public class LoggerImplUnitTests {
    ...
    public void log_ShouldPublishCorrectLogEntry() {
        ...
        Logger loggerToTest = new LoggerImpl(logConfiguration, logEntryPublisher);
        loggerToTest.log(expectedLogLevelType, expectedOriginalMessage, expectedArguments);
        ...
        assertThat(actual.getOriginalMessage()).isSameAs(expectedOriginalMessage);
        assertThat(actual.getArguments()).isSameAs(expectedArguments);
        assertThat(actual.getCompiledMessage()).isEqualTo(expectedCompiledMessage);
    }
