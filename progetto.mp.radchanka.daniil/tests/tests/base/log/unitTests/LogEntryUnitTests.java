...
public class LogEntryUnitTests {
    ...
    public void getCompiledMessage_ShouldUseSpecifiedCompiledMessageBuilderWithOriginalMessageAndArguments() {
        ...
        String passedOriginalMessage = compiledMessageProvider.getLastSpecifiedOriginalMessage();
        Object[] passedArguments = compiledMessageProvider.getLastSpecifiedArguments();
