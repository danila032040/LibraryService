...
public class BookUnitTests {
	...
	public void createNewBook_WhenNameIsNull_ShouldThrowNullPointerException() {
		ThrowingCallable actual = () -> Book.createNewBook(new BookId(0), null, "", 2000, Optional.empty(),
				Optional.empty());
	...
	public void createNewBook_WhenPublicationYearIsNegative_ShouldThrowIllegalArgumentException() {
		ThrowingCallable actual = () -> Book.createNewBook(new BookId(0), "", "", -1, Optional.empty(),
				Optional.empty());
	...
	@Test
	public void createNewBook_ShouldAddBookCreatedDomainEvent() {
	...
	@Test
	public void borrowByUser_WhenBookWereNotBorrowedByAnyOne_ShouldSetBorrowedByUser()
		...
		Optional<UserId> actualUserId = book.getBorrowedByUserId();
		Collection<DomainEvent> actualDomainEvents = book.extractAllDomainEvents();

		assertThat(actualUserId).hasValue(userId);
		assertThat(actualDomainEvents).satisfiesExactly(
	...
	public void borrowByUser_WhenBookWereBorrowedByOtherUser_ShouldThrowBookIsAlreadyBorrowedByAnotherUserDomainException()
		...
		assertThatExceptionOfType(BookIsAlreadyBorrowedByAnotherUserDomainException.class).isThrownBy(actual)
				.satisfies(exception -> {
	...
	public void returnByUser_WhenBookWereNotBorrowedByAnyOne_ShouldThrowUserTriedToReturnTheBookThatWereNotBorrowedDomainException()
		...
		assertThatExceptionOfType(UserTriedToReturnTheBookThatWereNotBorrowedDomainException.class).isThrownBy(actual)
				.satisfies(exception -> {
					assertThat(exception.getBook()).isSameAs(book);
	...
	public void returnByUser_WhenBookWereBorrowedByOtherUser_ShouldUserTriedToReturnTheBookOfAnotherUserDomainException()
		...
		assertThatExceptionOfType(UserTriedToReturnTheBookOfAnotherUserDomainException.class).isThrownBy(actual)
				.satisfies(exception -> {
					assertThat(exception.getBook()).isSameAs(book);
	...
	@Test
	public void borrowByUser_WhenBookWereBorrowedByTheSameUser_Should()
			throws BookIsAlreadyBorrowedByAnotherUserDomainException {
		UserId userId = new UserId(1);
		Book book = Book.createNewBook(new BookId(1), "", "", 2000, Optional.empty(), Optional.empty());
		book.extractAllDomainEvents();
