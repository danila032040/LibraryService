...
public enum BookSortByFieldQueryData {
	id {
		...
		public SortCriteria<Book> createSortCriteria(SortType sortType) {
			return SortCriteria
					.<Book, BookId>sortBy(book -> book.getId(), sortType);
		}
		@Override
		public SortCriteria<Book> applyThenSort(
	...
	name {
		...
		public SortCriteria<Book> createSortCriteria(SortType sortType) {
			return SortCriteria
					.<Book, String>sortBy(book -> book.getName(), sortType);
		}
		@Override
		public SortCriteria<Book> applyThenSort(
				SortCriteria<Book> sortCriteria,
	...
	genre {
		...
		public SortCriteria<Book> createSortCriteria(SortType sortType) {
			return SortCriteria
					.<Book, String>sortBy(book -> book.getGenre(), sortType);
		}
		@Override
		public SortCriteria<Book> applyThenSort(
				SortCriteria<Book> sortCriteria,
	...
	publicationYear {
		...
		public SortCriteria<Book> applyThenSort(
				...
				SortType sortType) {
			return sortCriteria
					.thenSortBy(book -> book.getPublicationYear(), sortType);
		}
	},
	authorId {
		@Override
		public SortCriteria<Book> createSortCriteria(SortType sortType) {
			Comparator<Book> comparator = ComparatorUtils
					.comparingOptionalField(book -> book.getAuthorId());
			return SortCriteria
	...
	libraryId {
		...
		public SortCriteria<Book> createSortCriteria(SortType sortType) {
			Comparator<Book> comparator = ComparatorUtils
					.comparingOptionalField(book -> book.getLibraryId());
			return SortCriteria
					.<Book>sortUsingComparator(
							sortType == SortType.Descending
									? comparator.reversed()
	...
	public abstract SortCriteria<Book> applyThenSort(
			SortCriteria<Book> sortCriteria,
			SortType sortType);
}
