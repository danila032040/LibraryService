package application.events.book.returnByUser;
...
public class ReturnedByUserDomainEventHandler
	...
	public ReturnedByUserDomainEventHandler(Logger logger,
	...
	@Override
	public void handle(
			DomainEventNotification<BookReturnedByUserDomainEvent> notification) {
		try {
