...
public class LoggerImpl implements Logger {
    ...
    public LoggerImpl(LogConfiguration globalLogConfiguration, LogEntryPublisher logEntryPublisher) {
        ...
        logEntryPublisher
                .publish(
                        new LogEntry(
                                ...
                                message,
                                args,
                                (originalMessage, arguments) -> MessageFormatSupportingTimePackage
                                        .of(originalMessage, logConfiguration.getLocale())
                                        .format(arguments)));
