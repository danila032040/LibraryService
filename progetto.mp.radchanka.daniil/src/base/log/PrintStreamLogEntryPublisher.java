...
public class PrintStreamLogEntryPublisher implements LogEntryPublisher {
	...
	public PrintStreamLogEntryPublisher(Supplier<Locale> localeSupplier,
			Supplier<String> timeStampFormatSupplier, PrintStream printStream) {
		this.localeSupplier = Objects.requireNonNull(localeSupplier);
		this.timeStampFormatSupplier = Objects
				.requireNonNull(timeStampFormatSupplier);
