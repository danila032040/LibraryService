...
public class ConverterChainElementImpl<TFrom, TTo> implements Converter<TFrom, TTo>, ConverterChainElement<TFrom, TTo> {
    
    public static <TFrom, TTo> ConverterChainElementImpl<TFrom, TTo> from(Converter<TFrom, TTo> converter) {
        return new ConverterChainElementImpl<>((from) -> true, converter);
    }
    ...
    public static <TFrom, TTo> ConverterChainElementImpl<TFrom, TTo> from(
        ...
        return new ConverterChainElementImpl<>(canHandlePredicate, converter);
    }
    ...
    private ConverterChainElementImpl(Predicate<TFrom> canHandlePredicate, Converter<TFrom, TTo> converter) {
