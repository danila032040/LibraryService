...
public class Library extends Entity<LibraryId> implements Cloneable<Library> {
    public static Library createNewLibrary(LibraryId id, Address address) {
        ...
        createdLibrary.registerDomainEvent(new LibraryCreatedDomainEvent(createdLibrary));
    ...
    public void changeAddress(Address address) {
        ...
        this.registerDomainEvent(new LibraryAddressChangedDomainEvent(this, previous, current));
    }
    
    @Override
    public Library createClone() {
        return new Library(this.getId().createClone(), this.getAddress().createClone());
    }
