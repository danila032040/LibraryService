...
public class Author extends Entity<AuthorId> implements Cloneable<Author> {
    public static Author createNewAuthor(AuthorId id, String name, String surname, String country) {
        Author createdAuthor = new Author(id, name, surname, country);
        createdAuthor.registerDomainEvent(new AuthorCreatedDomainEvent(createdAuthor));
